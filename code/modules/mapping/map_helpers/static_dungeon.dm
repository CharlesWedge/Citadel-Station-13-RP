...
/obj/map_helper/train_loader/New()
	return ..()

/obj/map_helper/train_loader/Initialize(mapload)
	return ..()

/obj/map_helper/train_loader/map_initializations(list/bounds, lx, ly, lz, ldir)
	. = ..()
...
/obj/map_helper/train_loader/proc/get_turfs_to_clean(lx, ly, lz, ldir)
	. = list()
	if(clean_turfs)
...
/obj/map_helper/train_loader/proc/annihilate_bounds(lx, ly, lz, ldir)
	var/deleted_atoms = 0
